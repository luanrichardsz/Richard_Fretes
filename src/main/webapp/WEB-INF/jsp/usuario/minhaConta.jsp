...
<head>
    ...
    <link rel="stylesheet" href="/RichardFretes/css/styleForm.css" /> <%-- CSS novo para formulários --%>
                ...
                <form action="/RichardFretes/minhaConta" method="post">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="<%= usuario.isAdmin() ? "Administrador" : "Responsável Empresa" %>" disabled class="input-disabled">
                        </div>
                    </div>
